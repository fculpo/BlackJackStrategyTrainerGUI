...
Board.prototype.sendUpdate = function (socket) {
  ...
  var self = this;
  this.io.sockets.emit('updateBoard', { board: self.uuid, players : [ { cards: [self.players[0].hand[0].toURL(), self.players[0].hand[1].toURL()] } ], dealer: {cards: [self.dealer.hand[0].toURL()]} } );
}
